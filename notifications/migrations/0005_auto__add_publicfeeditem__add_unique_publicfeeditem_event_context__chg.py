...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PublicFeedItem'
        db.create_table(u'notifications_publicfeeditem', (
        ...
        db.send_create_signal('notifications', ['PublicFeedItem'])

        # Adding unique constraint on 'PublicFeedItem', fields ['event', 'context']
        db.create_unique(u'notifications_publicfeeditem', ['event_id', 'context'])


        # Changing field 'Event.site'
        db.alter_column(u'notifications_event', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['sites.Site'], null=True))

    def backwards(self, orm):
        # Removing unique constraint on 'PublicFeedItem', fields ['event', 'context']
        db.delete_unique(u'notifications_publicfeeditem', ['event_id', 'context'])

        # Deleting model 'PublicFeedItem'
        db.delete_table(u'notifications_publicfeeditem')


        # Changing field 'Event.site'
        db.alter_column(u'notifications_event', 'site_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['sites.Site']))
