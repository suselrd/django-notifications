...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transport.allows_subscription'
        db.add_column(u'notifications_transport', 'allows_subscription',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transport.allows_subscription'
        db.delete_column(u'notifications_transport', 'allows_subscription')
