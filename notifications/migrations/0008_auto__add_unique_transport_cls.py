...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Transport', fields ['cls']
        db.create_unique(u'notifications_transport', ['cls'])


    def backwards(self, orm):
        # Removing unique constraint on 'Transport', fields ['cls']
        db.delete_unique(u'notifications_transport', ['cls'])
