...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'EventTypeCategory', fields ['name']
        db.create_unique(u'notifications_eventtypecategory', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'EventTypeCategory', fields ['name']
        db.delete_unique(u'notifications_eventtypecategory', ['name'])
