...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'notifications.attendantrole': {
            'Meta': {'object_name': 'AttendantRole'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'priority': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'role': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '200'})
        },
        'notifications.defaultsubscription': {
            'Meta': {'object_name': 'DefaultSubscription'},
            ...
            'transport': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['notifications.Transport']", 'unique': 'True'})
        },
        'notifications.event': {
