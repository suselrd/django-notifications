...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'SubscriptionFrequency', fields ['name']
        db.create_unique(u'notifications_subscriptionfrequency', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'SubscriptionFrequency', fields ['name']
        db.delete_unique(u'notifications_subscriptionfrequency', ['name'])
